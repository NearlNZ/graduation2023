                        ...
                        <div class="tab-pane fade show active" id="navs-pills-top-data" role="tabpanel">
                            ...
                            <form id="formCreateDatabase" class="mb-3" action="script/script-createDatabase.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="useDatabase" name="database" placeholder="โปรดเชื่อมต่อกับฐานข้อมูล" value="<?php echo $database->database ?? ''; ?>" autocomplete="off" readonly/>
                                </div>
                                <div class="mb-1">
