                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="navs-pills-top-account" role="tabpanel">
                                ...
                                <p class="mb-3 fw-normal">
                                    เพิ่มบัญชีผู้ดูแลระบบสำหรับการเข้าใช้งาน
                                </p>
                                <form id="formCreateAccount" class="mb-3" action="../data/user/createNewAccount.php" method="POST">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="useDatabase" name="database" placeholder="โปรดเตรียมฐานข้อมูลให้พร้อม" value="<?php echo $importData ? $database : ''; ?>" autocomplete="off" <?php echo $database !== '' ? 'readonly' : 'disabled'; ?> />
                                    </div>
                                    <input type="hidden" id="level" name="userLevel" value="Admin">
                                    <div class="mb-1">
                                        <label for="username" class="form-label">Username</label>
                                        <input type="text" class="form-control" id="username" name="username" placeholder="Enter username." maxlength="50" autofocus autocomplete="off" required <?php if (!$importData) echo 'disabled'; ?> />
                                    </div>
                                    <div class="form-password-toggle mb-1">
                                        <label for="password" class="form-label">Password</label>
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="password" name="password" placeholder="Enter password." minlength="8" maxlength="20" autocomplete="off" required <?php if (!$importData) echo 'disabled'; ?> />
                                    ...
                                    <div class="form-password-toggle mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="confirmPassword" name="confirmPassword" placeholder="Enter password again." minlength="8" maxlength="20" autocomplete="off" required <?php if (!$importData) echo 'disabled'; ?> />
                                            <a class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></a>
                                        </div>
                                    </div>
                                    <button id="submitBtn" class="btn btn-primary w-100" <?php if (!$importData) echo 'disabled'; ?>>
